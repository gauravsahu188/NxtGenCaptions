...
exports.commonPhrasesMap = exports.commonWordsMap = void 0;
exports.preProcessPhrases = preProcessPhrases;
exports.containsDevanagari = containsDevanagari;
exports.transliterateWord = transliterateWord;
exports.transliterateHindiToRoman = transliterateHindiToRoman;
exports.processHinglishCaptions = processHinglishCaptions;
...
exports.commonWordsMap = new Map([
...
exports.commonPhrasesMap = new Map([
...
function preProcessPhrases(text) {
    ...
    const sortedPhrases = Array.from(exports.commonPhrasesMap.keys()).sort((a, b) => b.length - a.length);
    for (const phrase of sortedPhrases) {
        if (processed.includes(phrase)) {
            const replacement = exports.commonPhrasesMap.get(phrase);
...
function transliterateWord(word) {
    ...
    if (exports.commonWordsMap.has(trimmed)) {
        return exports.commonWordsMap.get(trimmed);
    }
 ...
 */
function processHinglishCaptions(captions) {
    return captions.map(segment => {
        ...
        const convertedText = containsDevanagari(phraseProcessedText)
            ...
            : phraseProcessedText;
        const convertedWords = segment.words?.map((word) => {

...
export const metadata: Metadata = {
  title: "About Us — NxtGen Captions",
  description: "Learn more about NxtGen Captions, a production-grade, AI-driven storytelling platform built to bridge the gap between raw footage and viral, cinematic content.",
  openGraph: {
    title: "About Us — NxtGen Captions",
    description: "Learn more about NxtGen Captions, a production-grade, AI-driven storytelling platform built to bridge the gap between raw footage and viral, cinematic content.",
    type: "website",
    url: "https://nxtgencaptions.com/about",
  },
};

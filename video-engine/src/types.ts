...
export interface CaptionStyleProps {
  ...
  layout: "center" | "modern" | "bubble" | "hormozi" | "ali-abdaal" | "gadzhi" | "apple" | "mogrt-shimmer-stack" | "nxtgen-genz" | "nxtgen-alpha" | "nxtgen-horror" | "nxtgen-cinemaline" | "top" | "bottom" | string;
  fontFamily: string;
  fontWeight: string;
  fontSize: number;
  positionX: number;

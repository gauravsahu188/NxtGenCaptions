...
export interface NxtGenAlphaProps {
  ...
  /** Font family for middle word (default: Inter/Montserrat) */
  fontFamily?: string;
...
export const NxtGenAlpha: React.FC<NxtGenAlphaProps> = ({
  topText,
  heroText,
  bottomText,
  primaryColor = "#ffffff",
  ...
  return (
    ...
    >
      ...
      {/* Tier 1: Top Line - Left aligned, 96px, font-family Aston Script */}
      <div
        style={{
          position: "relative",
          textAlign: "left",
      ...
      {/* Tier 3: Bottom Line - Right aligned, 96px, font-family Aston Script */}
      <div
        style={{
          position: "relative",
          textAlign: "right",
